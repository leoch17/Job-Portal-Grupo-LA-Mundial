                    ...
                    <div class="card border-0 shadow mb-4 p-3">
                        <div class="card-body card-form">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fs-4 mb-1">Mis Empleos</h3>
                                </div>
                                <div style="margin-top: -10px;">
                                    <a href="{{ route('account.createJob') }}" class="btn btn-primary">Públicar un
                                        Trabajo</a>
                                </div>
                                ...
                                <table class="table ">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th scope="col">Trabajo Creado</th>
