<div class="card border-0 shadow mb-4 p-3">
    <div class="s-body text-center mt-3">
        ...
        <div class="d-flex justify-content-center mb-2">
            <button data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" class="btn btn-primary">Cambiar
    ...
    <div class="card-body p-0">
        <ul class="list-group list-group-flush ">
            <li class="list-group-item d-flex justify-content-between p-3 fs-5">
                <a href="{{ route('account.profile') }}">Ajustes de Cuenta</a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3 fs-5">
                <a href="{{ route('account.createJob') }}">Publica un Empleo</a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3 fs-5">
                <a href="{{ route('account.myJobs') }}">Mis Empleos</a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3 fs-5">
                <a href="{{ route('account.myJobApplications') }}">Empleos Aplicados</a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3 fs-5">
                <a href="{{ route('account.savedJobs') }}">Empleos Guardados</a>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center p-3 fs-5">
