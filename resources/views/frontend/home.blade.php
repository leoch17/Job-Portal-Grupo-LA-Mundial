...
@section('main')
    <section class="section-0 lazy d-flex bg-image-style dark align-items-center " class=""
        data-bg="{{ asset('assets/images/banner-5.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-8">
                    <h1>Encuentra tu trabajo de ensueño</h1>
                    <p>Miles de trabajos disponibles.</p>
                    <div class="banner-btn mt-5"><a href="{{ route('jobs') }}" class="btn btn-primary mb-4 mb-sm-0">Explorar
                            Ahora</a>
                    </div>
                </div>
            </div>
