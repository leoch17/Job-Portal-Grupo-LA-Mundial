            ...
            <div class="row pb-5">
                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="descript_wrap white-bg">
                            ...
                            <div class="pt-3 text-end">
                                ...
                                @if (Auth::check())
                                    <button onclick="applyJob({{ $job->id }})" class="btn btn-primary">Aplicar</button>
                                @else
                            ...
                            <div class="card shadow border-0 mt-4">
                                ...
                                <div class="descript_wrap white-bg">
                                    <table class="table table-striped">
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="3">Candidatos no encontrados</td>
                                            </tr>
                                        @endif
                                    </table>
                ...
                <div class="col-md-4">
                        ...
                        <div class="job_sumary">
                            ...
                            <div class="job_content pt-3">
                                <ul>
                                    ...
                                    <li>Vacante: <span>{{ $job->vacancy }}</span></li>
                                    @if (!empty($job->salary))
                                        <li>Salario: <span><i class="fa fa-usd"></i>{{ $job->salary }}</span></li>
                                    @endif
                                    <li>Ubicación: <span>{{ $job->location }}</span></li>
                                    <li>Tipo de Trabajo: <span> {{ $job->jobType->name }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow border-0 my-4">
                        <div class="job_sumary">
                            <div class="summery_header pb-1 pt-4">
                                <h3>Detalles de la Compañia</h3>
                            </div>
                            <div class="job_content pt-3">
                                <ul>
                                    <li>nombre: <span>{{ $job->company_name }}</span></li>
                                    @if (!empty($job->company_location))
                                        <li>Ubicación: <span>{{ $job->company_location }}</span></li>
                                    @endif
...
@section('customJs')
    <script type="text/javascript">
        function applyJob(id) {
            if (confirm("¿Estas seguro que quieres aplicar para este trabajo?")) {
                $.ajax({
                    url: '{{ route('applyJob') }}',
                    type: 'post',
                    data: {
